(function () {
    ...
    const TRANSLATIONS = {
        uk: {
            ...
            "reviews.formIntro": "Вкажіть товар та оцінку. Ім'я і докладний текст можна не заповнювати.",
            "reviews.productLabel": "Придбаний товар *",
            ...
            "reviews.ratingLabel": "Ваша оцінка *",
        ...
        ru: {
            ...
            "reviews.formIntro": "Укажите товар и оценку. Имя и подробный текст можно не заполнять.",
            "reviews.productLabel": "Приобретенный товар *",
        ...
        en: {
            ...
            "reviews.formIntro": "Choose the product and rating. Your name and detailed text are optional.",
            "reviews.productLabel": "Purchased product *",
