(function () {
    ...
    const TRANSLATIONS = {
        uk: {
            ...
            "quick.download": "Завантажити перелік продуктів",
            "quick.downloadShort": "Перелік",
            "quick.downloadTitle": "Завантажити Excel-перелік продуктів Nikas",
            "cart.title": "Заявка",
        ...
        ru: {
            ...
            "quick.telegram": "Telegram",
            "quick.request": "Заявка",
            "quick.download": "Скачать перечень продуктов",
            "quick.downloadShort": "Перечень",
            "quick.downloadTitle": "Скачать Excel-перечень продуктов Nikas",
            "cart.title": "Заявка",
        ...
        en: {
            ...
            "quick.download": "Download product list",
            "quick.downloadShort": "List",
            "quick.downloadTitle": "Download the Nikas Excel product list",
            "cart.title": "Request",
